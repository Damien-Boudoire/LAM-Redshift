...
X_train, X_valid, X_test, target_train, target_valid, target_test , Y_train, Y_valid, Y_test , nb_classes, nom_classes = dataset_redshift(Data, Undersample=False)
...
Save_in_dict(model, X_test_cnn, target_test, X_train_cnn, target_train, h, nb_classes, nom_classes, 'CNN_DeltaZ_2e-3')
